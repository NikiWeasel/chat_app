...
class _AuthScreenState extends State<AuthScreen>{
  ...
  void _submit() async{
    ...
    on FirebaseAuthException catch(error){
      ...
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text(error.message ?? 'Authentification failed.')));
                  ...
                  child: Padding(
                    ...
                    child: Form(
                      ...
                      child: Column(
                        ...
                        children: [
                          if (!_isLogin)
                            UserImagePicker(onPickedImage: (File pickedImage) { _selectedImage = pickedImage; },),
                          ...
                          if (!_isLogin)
                            TextFormField(
                              ...
                              validator: (value){
                                if (value == null || value.isEmpty || value.trim().length<4 || value.trim().length>10){
